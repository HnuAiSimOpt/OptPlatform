from ui.main.raw.Ui_procedures_sa import Ui_Form
from PyQt5.QtWidgets import QWidget, QPushButton
from PyQt5.QtGui import QPixmap, QIcon
from PyQt5.QtCore import QSize

class ProcedureSADiagram(QWidget, Ui_Form):
    def __init__(self):
        super(ProcedureSADiagram, self).__init__()
        self.setupUi(self)
        self.__initUI__()
